...
5. **إرسال تأكيد الموعد عبر الواتساب** - ضمان وصول تفاصيل الموعد للمريض
...
- **إذا تم التأكيد:** استخدم `check_patient_whatsapp_status` للتحقق من التسجيل
- **إذا لم يتم التأكيد:** اطلب من المريض تقديم رقم هاتف آخر
...
AI: [يستخدم send_whatsapp_message لإرسال التأكيد]
AI: "تم حجز موعدك بنجاح! 🎉 ستصلك رسالة تأكيد عبر الواتساب قريباً."
```
